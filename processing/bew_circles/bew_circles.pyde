...
def setup():
    ...
    filename = '/Users/FrancescaPadovani/Desktop/generate_plot/swarm_contours_1.csv'
    ...
    for i in range(len(coordinates_x)):
        circle_two(coordinates_x[i], coordinates_y[i], radius)
        radius += 1 '''
        
    #I choose to plot my cicles with circle_three style
    radius = 2
    for i in range(len(coordinates_x)):
        circle_three(coordinates_x[i], coordinates_y[i], radius)
        radius += 0.7
